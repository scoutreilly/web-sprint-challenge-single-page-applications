...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   -- useRouteMatch is used for matching and reading the url, not the redirect itself.
1. How would you explain form validation to someone who has never programmed before?
   -- Have you ever filled out a form and missed one field, then you hit submit and it erases ALL the fields? Then you have to fill it out over again? Validation stops that from happeneing!
1. In 1-2 sentences, define end to end testing.
   -- end to end testing is to veify a single page application works well from start to finish. Verifying the user process.
